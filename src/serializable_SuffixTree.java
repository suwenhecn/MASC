/*
public class serializable_SuffixTree {
 ...
 *
 */
public class serializable_SuffixTree implements Serializable{
	...
	public void build(String word) {
		...
		while (index < chars.length) {
			int currenctIndex = index++;
			char w = chars[currenctIndex];
			if (find(w)) {
				reminder++;
				continue;
			}
...
//		System.out.println("find结束"+activePoint.toString());
	 ...
	 * </p>
	 */
	private class ActivePoint implements Serializable{
		public Node point;
		public Node index;
		public int length;
