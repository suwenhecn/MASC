/*
public class pair_wise_alignment {
...
public class pair_wise_alignment {
	...
	/*===========================================*/
	public pair_wise_alignment(String c,String i,int [][] n,int length){
		center=c;
		si=i;
		name=n;
	...
	public void midalign(int j) {
		...
		String strC = center.substring(name[0][j - 1] + name[2][j - 1],name[0][j]);// 此处有漏洞，如果Name[center][i][0][0]=0，会抱错
